              ...
              {order.items?.map((item, index) => (
                <div className="order-item-detail" key={index}>
                  <div className="item-image">
                    <img 
                      src={item.product?.imageUrl ? (item.product.imageUrl.startsWith('http') ? item.product.imageUrl : `http://127.0.0.1:8080${item.product.imageUrl}`) : 'https://via.placeholder.com/80'} 
