  ...
  const handleAddToCart = () => {
    if (product) {
      dispatch(addToCart({
        ...
        imageUrl: product.image_main ? `http://localhost:8080/product-images/${product.image_main}` : `https://via.placeholder.com/400x300/eeeeee/333333?text=${encodeURIComponent(product.name)}`,
        sku: product.sku,
        quantity
      }));
      // Show notification
    ...
    <div className="product-details-container">
      <div className="product-details-grid">
        <div className="product-details-image">
          {/* Main product image */}
          <img 
            src={currentImage ? `http://localhost:8080/product-images/${currentImage}` : `https://via.placeholder.com/400x300/eeeeee/333333?text=${encodeURIComponent(product.name)}`} 
            alt={product.name} 
          ...
          {product.images_gallery && (
            <div className="product-image-gallery">
              ...
              >
                <img 
                  src={`http://localhost:8080/product-images/${product.image_main}`} 
              ...
              {JSON.parse(product.images_gallery).map((img, index) => (
                ...
                >
                  <img 
                    src={`http://localhost:8080/product-images/${img}`} 
